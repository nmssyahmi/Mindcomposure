...
import 'package:mindcomposure/src/screens/TreatmentScreen/YogaModule/HeadtoKnee/ListInstruction/Head1.dart';
...
class WelcomeHead extends StatefulWidget {
  @override
  _WelcomeHeadState createState() => _WelcomeHeadState();
}
...
class _WelcomeHeadState extends State<WelcomeHead> {
  ...
  void initState() {
    ...
    flutterTts.speak(yogaInstructionsHeadtoKnee[0]);
  }
      ...
      body: GestureDetector(
        onTap: () {
          Navigator.of(context).pushReplacement(
              MaterialPageRoute(builder: (context) => InstructionHead1()));
        },
        child: Container(
