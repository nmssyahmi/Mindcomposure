...
import 'package:mindcomposure/src/screens/TreatmentScreen/YogaModule/ChildPoses/ListInstruction/InstructionsChild1.dart';
...
class WelcomeChild extends StatefulWidget {
  @override
  _WelcomeChildState createState() => _WelcomeChildState();
}
...
class _WelcomeChildState extends State<WelcomeChild> {
  ...
  void initState() {
    ...
    flutterTts.speak(yogaInstructionsChild[0]);
  }
      ...
      body: GestureDetector(
        onTap: () {
          Navigator.of(context).pushReplacement(
              MaterialPageRoute(builder: (context) => InstructionChild1()));
        },
        child: Container(
