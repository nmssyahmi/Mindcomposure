...
class InstructionDigit4 extends StatefulWidget {
  @override
  _InstructionDigit4State createState() => _InstructionDigit4State();
}

class _InstructionDigit4State extends State<InstructionDigit4> {
  ...
  void initState() {
    ...
    flutterTts.speak(instructions4_7_8[4]);
