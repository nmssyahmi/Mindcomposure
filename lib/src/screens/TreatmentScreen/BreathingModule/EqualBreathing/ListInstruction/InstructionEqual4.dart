...
class InstructionEqual4 extends StatefulWidget {
  @override
  _InstructionEqual4State createState() => _InstructionEqual4State();
}

class _InstructionEqual4State extends State<InstructionEqual4> {
  ...
  void initState() {
    ...
    flutterTts.speak(instructionsEqual[4]);
