...
class InstructionSkull4 extends StatefulWidget {
  @override
  _InstructionSkull4State createState() => _InstructionSkull4State();
}

class _InstructionSkull4State extends State<InstructionSkull4> {
  ...
  void initState() {
    ...
    flutterTts.speak(instructionsSkull[4]);
