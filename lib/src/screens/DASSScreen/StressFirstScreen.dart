...
class StressFirstScreen extends StatefulWidget {
  @override
  _StressFirstScreenState createState() => _StressFirstScreenState();
}

class _StressFirstScreenState extends State<StressFirstScreen> {
  UserApp user;
  @override
